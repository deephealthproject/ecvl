...
|   OS    |  Compiler  | OpenCV | Status | 
|:-------:|:----------:|:------:|:------:|
| TODO | VS 15.9.11 | 3.4.6  |[![Build Status](https://jenkins-master-deephealth-unix01.ing.unimore.it/badge/job/DeepHealth/job/ecvl/job/master/windows_end?)](https://jenkins-master-deephealth-unix01.ing.unimore.it/job/DeepHealth/job/ecvl/job/master/)        |

### Windows GPU

|   OS    |  Compiler  | OpenCV | Status | 
|:-------:|:----------:|:------:|:------:|
| TODO | VS 15.9.11 | 3.4.6  |  Not available yet        |
