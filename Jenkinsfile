                        ...
                        stage('Build') {
                            steps {
                                timeout(15) {
                                    ...
                                    cmakeBuild buildDir: 'build', cmakeArgs: '-DECVL_TESTS=ON -DECVL_BUILD_EDDL=ON -DECVL_DATASET_PARSER=ON -DECVL_WITH_DICOM=ON -DECVL_WITH_OPENSLIDE=ON -DOPENSLIDE_LIBRARIES=C:/Library/openslide-win32-20171122/liblibopenslide.lib', installation: 'InSearchPath', sourceDir: '.', cleanBuild: true, steps: [
                                        [args: '-j4', withCmake: true]
                                    ]
                                }
                            }    
